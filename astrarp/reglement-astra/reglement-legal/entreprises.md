...
<figure><img src="https://1103532016-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FHAeWF9C5i1BoFU7up2Dj%2Fuploads%2Fv5VC3lAfwBIQqwL8REa4%2F19.png?alt=media&#x26;token=47abfe59-6f0b-4849-9ed5-97c3236321c5" alt=""><figcaption></figcaption></figure>

{% hint style="danger" %} <mark style="color:red;">**Le nombre d’employés maximal est de 30 personnes.**</mark>
{% endhint %}
...
* Il est <mark style="color:red;">**INTERDIT**</mark> d’utiliser vos permissions en dehors de votre service. \
  \&#xNAN;*<mark style="color:orange;">**Exemple : déverrouiller une voiture pour la voler.**</mark>*
* Il est <mark style="color:red;">**INTERDIT**</mark> de usebug pour raccourcir l'animation de réparation ou autre.
  {% endtab %}

{% tab title="Restaurants/Bars" %}
